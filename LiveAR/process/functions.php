...
*/    
    ...
    private function get_livestream_info(){
        ...
        $live_status['type'] = "connected";
        $stream_line['hls'] = "https://live.cdn.asset.aparat.com/cfbc650d9149489d1e0e84dc9f752fd1/eventhls/e4268f37df92ed203874f19f63cbc06eb.m3u8?e=".(time()+21600)."&ip=".$this->get_ip();
