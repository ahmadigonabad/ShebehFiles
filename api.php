...
<script src="http://taziyehkhani.ir/api/jquery-3.3.1.min.js" type="text/javascript"></script>
<script>
...
if(en == pre_len*next_len){
    document.getElementById("url").value="rtmp://185.147.178.62:443/event/e4268f37df92ed203874f19f63cbc06eb?s=e00f49a255a8e321";
