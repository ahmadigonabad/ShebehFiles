...
<html lang="fa">
    ...
    <body class="live-wrapper">
        ...
        <script type="text/javascript">
            ...
            (function(){var script = document.createElement("script");script.src = 'widget.js';script.type = 'text/javascript'; script.setAttribute("charset","utf-8"); document.head.appendChild(script);})();
        </script>
